...
import com.example.pergr.androidonlinequizapp.Model.Category;
import com.example.pergr.androidonlinequizapp.Model.User;
                ...
                if (dataSnapshot.child(user).exists()){
                    if(!user.isEmpty())
                    {
                        ...
                        if(login.getPassword().equals((pwd))) {
                            Intent homeActicity = new Intent(MainActivity.this, Home.class);
